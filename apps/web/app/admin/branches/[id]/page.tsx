        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {branch.latitude && branch.longitude && (
                    <div className="rounded-2xl bg-dark-900 p-8 shadow-float border border-slate-200 dark:border-slate-800 lg:col-span-2">
                    ...
                    <div className="rounded-2xl bg-dark-900 p-8 shadow-float border border-slate-200 dark:border-slate-800">
                        ...
                        <div className="space-y-2">
                            {["monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday"].map((day) => {
                                ...
                                return (
                                    <div key={day} className="flex items-center justify-between rounded-lg bg-dark-850 px-4 py-2.5 border border-slate-200 dark:border-slate-700">
                    ...
                    <div className="rounded-2xl bg-dark-900 p-8 shadow-float border border-slate-200 dark:border-slate-800">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {branch.amenities.map((a) => (
                                <span key={a} className="inline-flex rounded-full bg-dark-850 border border-slate-200 dark:border-slate-700 px-3 py-1.5 text-xs font-bold text-slate-600 dark:text-slate-300">{a}</span>
                            ))}
                        </div>
                    </div>
                )}
                ...
                <div className="rounded-2xl bg-dark-900 p-8 shadow-float border border-slate-200 dark:border-slate-800">
                    ...
                    <div className="space-y-4">
                        {branch.services.map((svc) => (
                            <div key={svc.id} className="rounded-xl border border-slate-200 dark:border-slate-800 p-5 bg-dark-850">
