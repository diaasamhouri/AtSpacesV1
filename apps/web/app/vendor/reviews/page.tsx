    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                {reviews.length === 0 ? (
                    <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-dark-900 p-12 text-center shadow-float">
                    ...
                    reviews.map((review) => (
                        <div key={review.id} className="rounded-2xl bg-dark-900 p-5 shadow-float border border-slate-200 dark:border-slate-800">
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="h-10 w-10 flex-shrink-0 overflow-hidden rounded-full bg-dark-800">
                                        {review.user?.image ? (
                                            ...
                                            <div className="flex h-full w-full items-center justify-center text-lg font-semibold text-slate-500 dark:text-slate-400 bg-dark-800">
                            ...
                            {review.vendorReply ? (
                                <div className="mt-4 rounded-lg bg-dark-850 border border-slate-200 dark:border-slate-800 p-4 relative">
                                    <div className="absolute -top-3 left-4 bg-dark-800 px-2 text-[10px] font-bold tracking-widest uppercase text-slate-500 dark:text-slate-400 rounded">
                                ...
                                <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-800">
                                    {replyingTo === review.id ? (
                                        <div className="space-y-3">
                                            <textarea
                                                rows={3}
                                                className="w-full rounded-xl border border-slate-200 dark:border-slate-700 p-3 text-sm text-gray-900 dark:text-white focus:border-brand-500 focus:ring-brand-500 bg-dark-850 focus:bg-dark-900 transition-colors"
                                            ...
                                            <div className="flex justify-end gap-2">
                                                <button
                                                    ...
                                                    className="rounded-lg px-4 py-2 text-sm font-medium text-slate-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-dark-800 transition-colors"
                                                >
                                                    Cancel
                                                </button>
                                                <button
