            ...
            {meta && meta.totalPages > 1 && (
                <div className="flex justify-center gap-2 pt-2">
                    <button
                        ...
                        disabled={page <= 1}
                        className="rounded-lg border border-slate-200 dark:border-slate-700 bg-dark-850 px-3 py-1.5 text-sm font-bold text-gray-900 dark:text-white hover:bg-dark-800 disabled:opacity-50 transition-colors"
                    >
                        Previous
                    </button>
