...
export default function ConfirmedBookingsPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const res = await getVendorBookings(token, { page, limit: 20, status: "CONFIRMED", search: search || undefined });
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Confirmed Bookings</h1>
      ...
      <DataTable
        ...
        exportable
        exportFilename="CONFIRMED-bookings"
        exportTitle="Confirmed Bookings"
        columnVisibility
