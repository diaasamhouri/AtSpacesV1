...
export default function InProgressBookingsPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const res = await getVendorBookings(token, { page, limit: 20, status: "CHECKED_IN", search: search || undefined });
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">In Progress Bookings</h1>
      ...
      <DataTable
        ...
        exportable
        exportFilename="CHECKED_IN-bookings"
        exportTitle="In Progress Bookings"
        columnVisibility
