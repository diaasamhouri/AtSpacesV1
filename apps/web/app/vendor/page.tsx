    ...
    return (
        <div className="space-y-8">
            ...
            {stats.stats.branches === 0 && (
                <div className="rounded-3xl bg-dark-900 border border-slate-200 dark:border-slate-800 p-10 text-center shadow-float">
            ...
            {stats.stats.branches > 0 && (
                <div className="flex flex-wrap gap-3">
                    <Link
                        ...
                        className="flex items-center gap-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-dark-900 px-5 py-3 text-sm font-bold text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-dark-850 hover:border-slate-700 transition-all"
                    >
